...
export const PROMO_CODES = {
  'DISKON10': { type: 'percentage', value: 0.1, label: 'Diskon 10%' },
  'HEMAT25': { type: 'fixed', value: 25000, label: 'Hemat 25rb' },
  'MAHASISWA': { type: 'percentage', value: 0.15, label: 'Diskon Mahasiswa 15%' },
  'VIPONLY': { type: 'percentage', value: 0.25, label: 'Diskon VIP 25%' }
}
 ...
 */
export function calculateEstimatedPrice(service, level, hoursToDeadline, referralCode = '') {
