        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a
              ...
              rel="noopener noreferrer"
              id="cta-btn-tg"
              className="inline-flex items-center gap-3 px-8 py-4 rounded-xl font-bold text-blue-600 text-lg
                         bg-white hover:bg-blue-50 shadow-lg transition-all duration-300 hover:-translate-y-1 w-full sm:w-auto justify-center"
            >
              <svg width={24} height={24} viewBox="0 0 24 24" fill="currentColor">
